...
public class commandeService {
    ...
    public boolean addcommande(commande t) {
        ...
        String url = Statics.BASE_URL + "commande/addcommandeJSON?"+"adresse="+adresse+"&etat="+etat+"&total="+total+"&DateCmd="+datecmd+"&IdPanier="+p.getId_panier();
     ...
     public boolean supprimercommande(commande t) {
        ...
        //String url = Statics.BASE_URL + "create?name=" + t.getName() + "&status=" + t.getStatus();
        String url = Statics.BASE_URL + "commande/deletecommandeJSON/"+t.getId_cmd();
    ...
    public ArrayList<commande> getAllCommandes(){
        String url = Statics.BASE_URL+"commande/Allcommandes";
